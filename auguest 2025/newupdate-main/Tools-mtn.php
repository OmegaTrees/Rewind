...
$scoreArray = [840,840,840,840,840,840,840,840,840,840,840,840,720,720,600,400,400,400,400];
...
curl_close($ch);
          ...
          $scoreArray = [840,840,840,840,840,840,840,840,840,840,840,840,720,720,600,400,400,400,400];
            ...
            $content = GetXavi($unique_id,$game_id,$score,$scoreArray);
            $jsonData = json_encode($data);
        ...
        function GetXavi($unique_id,$game_id,$score,$array){
            ...
            $url = "https://xavigen3-the-rizzmators-projects.vercel.app/token/$unique_id/$game_id/$score";
...
function generateRandomDivisionData($number,$url,$power,$memory,$increment,$uA) {
   $data = [];
    ...
    $result = [840,840,840,840,840,840,840,840,840,840,840,840,720,720,600,400,400,400,400];
...
//}
    ...
    echo "<br><hr> Results $flash<hr>";
    $query_str = parse_url($url, PHP_URL_QUERY);
    parse_str($query_str, $query_params);
    $unique_id = isset($query_params['unique_id']) ? $query_params['unique_id'] : '';
    $game_id = isset($query_params['game_id']) ? $query_params['game_id'] : '';

    $xavi = GetXavi($unique_id,$game_id,$skore,$flash);
    $cleanXavi = trim($xavi, '"');
